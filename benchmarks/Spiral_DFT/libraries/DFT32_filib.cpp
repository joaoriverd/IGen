...
static f64i_fil D1[64];

void init_DFT32_fil() {
    for(int i3 = 0; i3 <= 3; i3++) {
        for(int i10 = 0; i10 <= 1; i10++) {
            for(int i14 = 0; i14 <= 1; i14++) {
                D1[((16*i3) + (8*i10) + (4*i14))] = cospi((((f64i_fil )(2*(i3*((2*i14) + i10)))) / 32.));
                D1[(1 + (16*i3) + (8*i10) + (4*i14))] = sinpi((((f64i_fil )(2*(((2*(i3*((2*i14) + i10))) + 1) / 2))) / 32.));
                D1[(2 + (16*i3) + (8*i10) + (4*i14))] = cospi((((f64i_fil )(2*(i3*(4 + (2*i14) + i10)))) / 32.));
                D1[(3 + (16*i3) + (8*i10) + (4*i14))] = sinpi((((f64i_fil )(2*(((2*(i3*(4 + (2*i14) + i10))) + 1) / 2))) / 32.));
            }
        }
    }
}
...
void DFT32(f64i_fil  *Y, f64i_fil  *X) {
    ...
    for(int i3 = 0; i3 <= 3; i3++) {
        ...
        f64i_fil a309, a310, a319, a320, s61, s62, s63, s64
    ...
    for(int i2 = 0; i2 <= 7; i2++) {
        ...
        f64i_fil t265, t266, t267, t268, t269, t270, t271, t272;
        a383 = (2*i2);
        a384 = (a383 + 1);
        a385 = (a383 + 32);
        a387 = (a383 + 33);
