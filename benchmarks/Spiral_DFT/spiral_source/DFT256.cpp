...
static double D1[512];

void init_DFT256(double a) {
    for(int i3 = 0; i3 <= 15; i3++) {
        for(int i10 = 0; i10 <= 7; i10++) {
            D1[((32*i3) + (4*i10))] = cospi((((double )(2*(i3*i10))) / 256));
            D1[(1 + (32*i3) + (4*i10))] = sinpi((((double )(2*(((2*(i3*i10)) + 1) / 2))) / 256));
            D1[(2 + (32*i3) + (4*i10))] = cospi((((double )(2*(i3*(8 + i10)))) / 256));
            D1[(3 + (32*i3) + (4*i10))] = sinpi((((double )(2*(((2*(i3*(8 + i10))) + 1) / 2))) / 256));
        }
    }
}

void DFT256(double  *Y, double  *X) {
    static double T1[512];
    for(int i3 = 0; i3 <= 15; i3++) {
        ...
        double a662, a663, a672, a673, a682, a683, a692, a693
    ...
    for(int i2 = 0; i2 <= 15; i2++) {
        ...
        double a1008, a1009, a1018, a1019, a1028, a1029, a1038, a1039
