...
#include "benchmark/benchmark_config2.h"
#include "write_csv.h"

using namespace std;

const string interval_perf_file_name = "../results/interval_perf_f64i_vv.csv";
const string real_perf_file_name     = "../results/real_perf_f64i_vv.csv";

void benchmark_dgemm_f64i() {
    vector<double> perf_interval;
    vector<double> real_perf;

    cout << endl << "dgemm_benchmark_f64i started:" << endl;
