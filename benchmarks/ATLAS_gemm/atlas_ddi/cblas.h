...
dd_I cblas_dsdot(const int N, const f32_I *X, const int incX, const f32_I *Y,
                   const int incY);
f32_I  cblas_sdot(const int N, const f32_I  *X, const int incX,
                  const f32_I  *Y, const int incY);
dd_I cblas_ddot(const int N, const dd_I *X, const int incX,
                  const dd_I *Y, const int incY);
/*
...
dd_I cblas_dnrm2(const int N, const dd_I *X, const int incX);
dd_I cblas_dasum(const int N, const dd_I *X, const int incX);

f32_I  cblas_scnrm2(const int N, const void *X, const int incX);
f32_I  cblas_scasum(const int N, const void *X, const int incX);

dd_I cblas_dznrm2(const int N, const void *X, const int incX);
dd_I cblas_dzasum(const int N, const void *X, const int incX);
...
CBLAS_INDEX cblas_idamax(const int N, const dd_I *X, const int incX);
...
void cblas_dswap(const int N, dd_I *X, const int incX,
                 dd_I *Y, const int incY);
void cblas_dcopy(const int N, const dd_I *X, const int incX,
                 dd_I *Y, const int incY);
void cblas_daxpy(const int N, const dd_I alpha, const dd_I *X,
                 const int incX, dd_I *Y, const int incY);
void catlas_daxpby(const int N, const dd_I alpha, const dd_I *X,
...
void cblas_drotg(dd_I *a, dd_I *b, dd_I *c, dd_I *s);
void cblas_drotmg(dd_I *d1, dd_I *d2, dd_I *b1, const dd_I b2, dd_I *P);
void cblas_drot(const int N, dd_I *X, const int incX,
                dd_I *Y, const int incY, const dd_I c, const dd_I s);
void cblas_drotm(const int N, dd_I *X, const int incX,
                dd_I *Y, const int incY, const dd_I *P);
...
void cblas_dscal(const int N, const dd_I alpha, dd_I *X, const int incX);
void cblas_cscal(const int N, const void *alpha, void *X, const int incX);
void cblas_zscal(const int N, const void *alpha, void *X, const int incX);
void cblas_csscal(const int N, const f32_I alpha, void *X, const int incX);
void cblas_zdscal(const int N, const dd_I alpha, void *X, const int incX);
...
void cblas_dgemv(const enum CBLAS_ORDER Order,
                 ...
                 const dd_I *X, const int incX, const dd_I beta,
                 dd_I *Y, const int incY);
void cblas_dgbmv(const enum CBLAS_ORDER Order,
                 const enum CBLAS_TRANSPOSE TransA, const int M, const int N,
                 const int KL, const int KU, const dd_I alpha,
                 const dd_I *A, const int lda, const dd_I *X,
                 const int incX, const dd_I beta, dd_I *Y, const int incY);
void cblas_dtrmv(const enum CBLAS_ORDER Order, const enum CBLAS_UPLO Uplo,
                 const enum CBLAS_TRANSPOSE TransA, const enum CBLAS_DIAG Diag,
                 const int N, const dd_I *A, const int lda,
                 dd_I *X, const int incX);
void cblas_dtbmv(const enum CBLAS_ORDER Order, const enum CBLAS_UPLO Uplo,
                 const enum CBLAS_TRANSPOSE TransA, const enum CBLAS_DIAG Diag,
                 const int N, const int K, const dd_I *A, const int lda,
                 dd_I *X, const int incX);
void cblas_dtpmv(const enum CBLAS_ORDER Order, const enum CBLAS_UPLO Uplo,
                 const enum CBLAS_TRANSPOSE TransA, const enum CBLAS_DIAG Diag,
                 const int N, const dd_I *Ap, dd_I *X, const int incX);
void cblas_dtrsv(const enum CBLAS_ORDER Order, const enum CBLAS_UPLO Uplo,
                 const enum CBLAS_TRANSPOSE TransA, const enum CBLAS_DIAG Diag,
                 const int N, const dd_I *A, const int lda, dd_I *X,
                 const int incX);
...
void cblas_dsymv(const enum CBLAS_ORDER Order, const enum CBLAS_UPLO Uplo,
                 const int N, const dd_I alpha, const dd_I *A,
                 const int lda, const dd_I *X, const int incX,
                 const dd_I beta, dd_I *Y, const int incY);
void cblas_dsbmv(const enum CBLAS_ORDER Order, const enum CBLAS_UPLO Uplo,
                 const int N, const int K, const dd_I alpha, const dd_I *A,
                 const int lda, const dd_I *X, const int incX,
                 const dd_I beta, dd_I *Y, const int incY);
void cblas_dspmv(const enum CBLAS_ORDER Order, const enum CBLAS_UPLO Uplo,
                 const int N, const dd_I alpha, const dd_I *Ap,
                 const dd_I *X, const int incX,
                 const dd_I beta, dd_I *Y, const int incY);
void cblas_dger(const enum CBLAS_ORDER Order, const int M, const int N,
                const dd_I alpha, const dd_I *X, const int incX,
                const dd_I *Y, const int incY, dd_I *A, const int lda);
void cblas_dsyr(const enum CBLAS_ORDER Order, const enum CBLAS_UPLO Uplo,
                const int N, const dd_I alpha, const dd_I *X,
                const int incX, dd_I *A, const int lda);
void cblas_dspr(const enum CBLAS_ORDER Order, const enum CBLAS_UPLO Uplo,
                const int N, const dd_I alpha, const dd_I *X,
                const int incX, dd_I *Ap);
...
void cblas_zher(const enum CBLAS_ORDER Order, const enum CBLAS_UPLO Uplo,
                const int N, const dd_I alpha, const void *X, const int incX,
                void *A, const int lda);
void cblas_zhpr(const enum CBLAS_ORDER Order, const enum CBLAS_UPLO Uplo,
                const int N, const dd_I alpha, const void *X,
                const int incX, void *A);
...
void cblas_dgemm(const enum CBLAS_ORDER Order, const enum CBLAS_TRANSPOSE TransA,
                 const enum CBLAS_TRANSPOSE TransB, const int M, const int N,
                 const int K, const dd_I alpha, const dd_I *A,
                 const int lda, const dd_I *B, const int ldb,
                 const dd_I beta, dd_I *C, const int ldc);
...
void cblas_zherk(const enum CBLAS_ORDER Order, const enum CBLAS_UPLO Uplo,
                 const enum CBLAS_TRANSPOSE Trans, const int N, const int K,
                 const dd_I alpha, const void *A, const int lda,
                 const dd_I beta, void *C, const int ldc);
void cblas_zher2k(const enum CBLAS_ORDER Order, const enum CBLAS_UPLO Uplo,
                  const enum CBLAS_TRANSPOSE Trans, const int N, const int K,
                  const void *alpha, const void *A, const int lda,
                  const void *B, const int ldb, const dd_I beta,
                  void *C, const int ldc);
