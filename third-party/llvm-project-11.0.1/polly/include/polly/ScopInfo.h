...
public:
  /// In case of a load that is part of a reduction like computation. Save the
  /// pointer to the respective store memory access. (JR)
  MemoryAccess* storeInReductionLike = nullptr;
