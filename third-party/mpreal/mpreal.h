...
{
    //mpfr_init2(mpfr_ptr(), mpreal::get_default_prec()); // hectorr
    mpfr_init2(mpfr_ptr(), 1024);
...
//        MPREAL_PERMISSIVE_EXPR static const int max_exponent10 = (int) (MPFR_EMAX_DEFAULT * 0.3010299956639811);
        MPREAL_PERMISSIVE_EXPR static const int min_exponent10 = (int) (MPFR_EMIN_DEFAULT * 3 / 10);
        MPREAL_PERMISSIVE_EXPR static const int max_exponent10 = (int) (MPFR_EMAX_DEFAULT * 3 / 10);
